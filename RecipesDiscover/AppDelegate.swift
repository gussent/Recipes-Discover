...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    {
        setupNavigationBarTextAttributes()
        
        window = UIWindow(frame: UIScreen.main.bounds)
        
        let rootVC = RDRootVC()
        let listVC = RDRecipesListVC()
        
        window!.rootViewController = rootVC
        window!.makeKeyAndVisible()
        
        rootVC.pushViewController(listVC, animated: false)
    ...
    fileprivate func setupNavigationBarTextAttributes()
    {
